...
from objectives import human_aligned_risk, entropic_risk, trimmed_risk, cvar, mean_variance
...
risk_functionals = {
    ...
    #'Mean-Variance=0.5': mean_variance.MeanVariance(c=0.5),
    #'Mean-Variance=1': mean_variance.MeanVariance(c=1),
    #'CVaR-0.2': cvar.CVaR(a=0.2),
    #'CVaR-0.4': cvar.CVaR(a=0.4),
    #'CVaR-0.6': cvar.CVaR(a=0.6),
    # 'CVaR-0.8': cvar.CVaR(a=0.8),
    'CVaR-0.9': cvar.CVaR(a=0.9),
    'CVaR-0.95': cvar.CVaR(a=0.95),
    # 'Mean-Variance=-0.1': mean_variance.MeanVariance(c=-0.1),
    # 'Entropic Risk=-0.5': entropic_risk.EntropicRisk(t=-0.5),
    # 'Entropic Risk=-1': entropic_risk.EntropicRisk(t=-1),
    # 'Entropic Risk=-1.5': entropic_risk.EntropicRisk(t=-1.5),
    # 'Entropic Risk=-2': entropic_risk.EntropicRisk(t=-2),
    # 'Human-Aligned Risk a=0.4 b=0.8': human_aligned_risk.HumanAlignedRisk(a=0.4, b=0.8),
    # 'Human-Aligned Risk a=0.2 b=0.0': human_aligned_risk.HumanAlignedRisk(a=0.2, b=0.0),
    # 'Human-Aligned Risk a=0.8 b=0.8': human_aligned_risk.HumanAlignedRisk(a=0.8, b=0.8),
    # 'Human-Aligned Risk a=0.8 b=0.8': human_aligned_risk.HumanAlignedRisk(a=0.8, b=0.0),
    # 'Human-Aligned Risk a=0.8 b=0.2': human_aligned_risk.HumanAlignedRisk(a=0.8, b=0.2),
    # 'Inverted CVaR-0.2': cvar.CVaR(a=0.2, inverted=True),
    # 'Inverted CVaR-0.4': cvar.CVaR(a=0.4, inverted=True),
    # 'Inverted CVaR-0.6': cvar.CVaR(a=0.6, inverted=True),
    # 'Inverted CVaR-0.8': cvar.CVaR(a=0.8, inverted=True),
    'Inverted CVaR-0.9': cvar.CVaR(a=0.9, inverted=True),
    'Inverted CVaR-0.95': cvar.CVaR(a=0.95, inverted=True),
    # 'Mean-Variance=0.1': mean_variance.MeanVariance(c=0.1),
    'Trimmed Risk-0.025': trimmed_risk.TrimmedRisk(a=0.025),
    'Trimmed Risk-0.05': trimmed_risk.TrimmedRisk(a=0.05),
    # 'Trimmed Risk-0.1': trimmed_risk.TrimmedRisk(a=0.1),
    # 'Trimmed Risk-0.2': trimmed_risk.TrimmedRisk(a=0.2),
    # 'Trimmed Risk-0.3': trimmed_risk.TrimmedRisk(a=0.3),
    # 'Trimmed Risk-0.4': trimmed_risk.TrimmedRisk(a=0.4),
}
